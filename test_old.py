...
#python test.py /home/yzhang/matrixnet/config/ACH_MatrixNetAnchorsResnet50 --testiter 100000 --split testing --debug
#python test.py /home/yzhang/matrixnet/config/FBM_MatrixNetCornersResnet50 --testiter 70000 --split testing
