...
class Config:
    def __init__(self):
        ...
        self._configs["data_dir"]   = "/home/yzhang/matrixnet_zy/data"
        self._configs["cache_dir"]  = "./cache"
        #self._configs["config_dir"] = "./config"
        self._configs["config_dir"] = "/home/yzhang/matrixnet_zy/config"
        #self._configs["result_dir"] = "./results(anchor)/ACH/MatrixNetAnchorsResnet50_48LayerRange_640isize/nnet/MatrixNetAnchors"
        self._configs["result_dir"] = "/home/yzhang/matrixnet_zy/results"
    ...
    @property
    def result_dir(self):
        result_dir = os.path.join(self._configs["result_dir"], self.model_name)
    ...
    def snapshot_dir(self):
        snapshot_dir = os.path.join(self.cache_dir, "nnet", self.model_name)
