...
from .resnet_features import resnet152_features, resnet50_features, resnet18_features, resnet101_features, resnext101_32x8d, wide_resnet101_2,rfdnet
...
class SubNet(nn.Module):
    ...
    def __init__(self, mode, classes=1, depth=4,
