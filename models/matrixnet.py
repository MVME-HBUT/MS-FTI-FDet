...
from .py_utils.utils import conv1x1, conv3x3,SELayer,Bottleneck,Bottleneck_2, Bottleneck_3
...
class MatrixNet(nn.Module):
    def __init__(self, resnet, layers):
        ...
        #self.incidence= {33:[34,43,44,22], 22:[11,32,23], 11:[12,21], 32:[42], 23:[24], 12:[13], 21:[31] ,42:[52],24:[25], 13:[14], 31:[41], 14:[15], 41:[51] }
        ...
        #@替换SE模块
        # self.pyramid_transformation_3 = SELayer(512, 128)
        # self.pyramid_transformation_4 = SELayer(1024, 128)
        # self.pyramid_transformation_5 = SELayer(2048, 128)
        
        self.pyramid_transformation_3 = SELayer(512, 96)
        self.pyramid_transformation_4 = SELayer(1024, 96)
        self.pyramid_transformation_5 = SELayer(2048, 96)
        
        # self.pyramid_transformation_3 = SELayer(512, 192)
        # self.pyramid_transformation_4 = SELayer(1024, 192)
        # self.pyramid_transformation_5 = SELayer(2048, 192)
        
        # self.pyramid_transformation_3 = SELayer(512, 64)
        # self.pyramid_transformation_4 = SELayer(1024, 64)
        # self.pyramid_transformation_5 = SELayer(2048, 64)
        
        # self.pyramid_transformation_3 = SELayer(512, 256)
        # self.pyramid_transformation_4 = SELayer(1024, 256)
        # self.pyramid_transformation_5 = SELayer(2048, 256)
        #################################################
        ...
        # self.pyramid_transformation_6 = Bottleneck_2(2048, 256,1)
        # self.pyramid_transformation_7 = Bottleneck(256,64,2,4)
        
        self.pyramid_transformation_6 = Bottleneck_2(2048, 96,1)
        self.pyramid_transformation_7 = Bottleneck(96,48,2,2)
        ...
        #@替换Bottleneck结构
        self.upsample_transform_1 = Bottleneck(96, 48,1,2)
        self.upsample_transform_2 = Bottleneck(96, 48,1,2)
        ...
        self.downsample_transformation_12 = Bottleneck_3(96, 48,(1,2))
        self.downsample_transformation_21 = Bottleneck_3(96, 48,(2,1))
    ...
    def forward(self, x):
        ...
        if 11 in self.visited:
            ...
            #_dict[11] = self.SELayer(resnet_feature_3)
