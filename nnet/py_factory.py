...
from grad_cam.main_cnn import cam
...
class NetworkFactory(object):
    def __init__(self, db):
        ...
        #self.network = DataParallel(self.network, chunk_sizes=8)

        # print('===================================')
        #print(self.network)

        # image = Image.open("/home/yzhang/matrixnet/1.jpg").convert('RGB')
        ...
        # summary(self.network,(1, 28, 28),batch_size=8,device="cpu")
        # print('===================================')
        # model = self.network
        # target_layers = [model.module.model.module]
        # cam(model,target_layers)
